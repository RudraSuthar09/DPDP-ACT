 ...
 * are honestly labelled as not-yet-built. Only Data Inventory and the Audit Log
 * are live in this shell.
 */
...
export const MODULE_NAV: NavItem[] = [
  ...
  { href: '/consent', label: 'Consent Register', active: false, note: 'Coming in your pilot' },
